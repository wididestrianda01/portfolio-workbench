...
def test_each_snapshot_stop_fires_on_its_planted_snapshot(tmp_path, kwargs, rule):
    """The three rules that are properties of the frozen files rather than of a frame: a line starting
    after the window opens, a bar whose month had not ended, and a month missing inside a series."""
